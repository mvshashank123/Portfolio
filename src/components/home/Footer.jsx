...
import {
  ...
  return (
    ...
    <div className="container container-fluid">
          ...
          <p className="lead text-center" style={{fontSize:'22px'}}>I'm currently looking for full-time Software Engineering or Machine Learning opportunities! If you know of 
            any positions available, have any questions, or just want to say hi, please feel free to email me at  
            <a href="mailto:mv.shashank123@gmail.com">{" "}
               mv.shashank123@gmail.com
            </a>{"."}
          </p>
    ...
    <footer style={{backgroundColor:'#f7f7f7'}} className="mt-auto py-3 text-center">
      ...
      <a
        ...
        rel="noopener"
        href="https://github.com/mvshashank123"
