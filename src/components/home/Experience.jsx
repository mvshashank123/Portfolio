  ...
  return (
    ...
    <br/>
      ...
      <div className="education">
        ...
        <p className="p__style2" style={{ fontSize: "22px" }}>09/2019-Present</p>
      ...
      <div className="education">
          ...
          <p className="p__style2" style={{ fontSize: "22px" }}>06/2018-08/2018</p>
        ...
        <div className="education">
          ...
          <p className="p__style2" style={{ fontSize: "22px" }}>03/2018-06/2018</p>
